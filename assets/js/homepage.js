...
if (nextBtn) {
	...
	{ image_url: 'assets/views/main/images/IMG_8733.JPG', categories: ['floral'], character: '3M Reflective Butterflies' },
        ...
        { image_url: 'assets/views/main/images/IMG_6056.jpeg', categories: ['colorways'] },
        { image_url: 'assets/views/main/images/IMG_9383.jpeg', categories: ['colorways'] },
        { image_url: 'assets/views/main/images/IMG_7955.jpg', categories: ['anime'], tags: ['vinland'], title: 'Other', character: 'Vinland Saga: Thorfinn' },
	{ image_url: 'assets/views/main/images/IMG_8558.jpg', categories: ['anime'], tags: ['blue-exorcist'], title: 'Other', character: 'Blue Exorcist: Rin' },
	{ image_url: 'assets/views/main/images/IMG_5932_Original.JPEG', categories: ['anime'], tags: ['demon-slayer'], title: 'Other', character: 'Demon Slayer: Nezuko' },
	{ image_url: 'assets/views/main/images/IMG_1008.jpg', categories: ['anime'], tags: ['fullmetal'], title: 'Other', character: 'Fullmetal Alchemist: Brotherhood' },
 	{ image_url: 'assets/views/main/images/IMG_6995.JPG', categories: ['anime'], tags: ['bungo'], title: 'Other', character: 'Bungo Stray Dogs' },
	{ image_url: 'assets/views/main/images/IMG_6943.JPG', categories: ['anime'], tags: ['bungo'], title: 'Other', character: 'Bungo Stray Dogs' },
	{ image_url: 'assets/views/main/images/IMG_3424.JPG', categories: ['anime'], tags: ['death-note'], title: 'Other', character: 'Death Note: Misa Amane' },
	{ image_url: 'assets/views/main/images/IMG_3588_Original.JPG', categories: ['anime'], tags: ['akame'], title: 'Other', character: 'Akame ga Kill!' },
        { image_url: 'assets/views/main/images/IMG_9082_Original.JPEG', categories: ['colorways'] },
        { image_url: 'assets/views/main/images/IMG_8968.jpg', categories: ['colorways'] },
	...
	{ image_url: 'assets/views/main/images/IMG_6538_Original.JPG', categories: ['anime'], tags: ['jojo'], title: "JoJo's Bizarre Adventure", character: 'Jotaro Kujo' },
        { image_url: 'assets/views/main/images/IMG_1490.jpg', categories: ['colorways'] },
        { image_url: 'assets/views/main/images/IMG_2647.jpg', categories: ['colorways'] },
        { image_url: 'assets/views/main/images/IMG_2698.jpg', categories: ['colorways'] },
        { image_url: 'assets/views/main/images/IMG_8451.jpg', categories: ['colorways'] },
        ...
        { image_url: 'assets/views/main/images/IMG_7310.jpg', categories: ['colorways'] },
        { image_url: 'assets/views/main/images/IMG_8100.jpg', categories: ['anime'], tags: ['naruto'], title: 'Naruto', character: 'Naruto & Sasuke' },
	{ image_url: 'assets/views/main/images/IMG_3569.JPG', categories: ['anime'], tags: ['naruto'], title: 'Naruto', character: 'Akatsuki Clouds (White AF1)' },
	{ image_url: 'assets/views/main/images/IMG_1218.JPG', categories: ['anime'], tags: ['naruto'], title: 'Naruto', character: 'Akatsuki Clouds: Pain' },
	{ image_url: 'assets/views/main/images/IMG_5349.JPG', categories: ['anime'], tags: ['naruto'], title: 'Naruto', character: 'Akatsuki Clouds (Black AF1)' },
        { image_url: 'assets/views/main/images/IMG_1482.jpg', categories: ['colorways'] },
        { image_url: 'assets/views/main/images/IMG_1626.jpg', categories: ['colorways'] },
        { image_url: 'assets/views/main/images/IMG_1566.jpeg', categories: ['colorways'] },
	{ image_url: 'assets/views/main/images/IMG_7598.jpg', categories: ['anime'], tags: ['hunter'], title: 'Hunter X Hunter', character: 'Hisoka' },
	{ image_url: 'assets/views/main/images/IMG_6266_Original.JPG', categories: ['anime'], tags: ['hunter'], title: 'Hunter X Hunter', character: 'Chrollo Lucilfer (Purple)' },
	...
	{ image_url: 'assets/views/main/images/IMG_6472_Original.JPG', categories: ['anime'], tags: ['hunter'], title: 'Hunter X Hunter', character: 'Killua Zoldyck' },
	{ image_url: 'assets/views/main/images/IMG_4651.JPG', categories: ['anime'], tags: ['hunter'], title: 'Hunter X Hunter', character: 'Kurapika' },
        { image_url: 'assets/views/main/images/IMG_7970.jpg', categories: ['anime'], tags: ['hunter'], title: 'Hunter X Hunter', character: 'Meruem' },
        { image_url: 'assets/views/main/images/IMG_1567.jpeg', categories: ['colorways'] },
        ...
        { image_url: 'assets/views/main/images/IMG_8454.jpg', categories: ['colorways'] },
        { image_url: 'assets/views/main/images/GreyAndWhite.jpeg', categories: ['colorways'] },
        { image_url: 'assets/views/main/images/IMG_6477.jpg', categories: ['anime'], tags: ['hunter'], title: 'Hunter X Hunter', character: 'Illumi Zoldyck' },
//        { image_url: 'assets/views/main/images/IMG_6203.JPG', category: 'custom-text' },
	...
	{ image_url: 'assets/views/main/images/IMG_7641.jpg', categories: ['schools-sports'], title: 'Football', character: 'Bengals Stripes' },
	...
	{ image_url: 'assets/views/main/images/IMG_1985.jpg', categories: ['schools-sports'], title: 'Hockey', character: 'Pawlings' },
	...
	{ image_url: 'assets/views/main/images/IMG_8734.jpg', categories: ['schools-sports'], title: 'Soccer', character: 'Club de Guadalajara' },
        { image_url: 'assets/views/main/images/IMG_8725.JPG', categories: ['cartoons'], tags: ['snoopy'], title: 'Snoopy', character: 'Snoopy, Joe Cool, & Woodstock' },
	...
	{ image_url: 'assets/views/main/images/IMG_8721.jpeg', categories: ['anime'], tags: ['jujutsu'], title: 'Jujutsu Kaisen', character: 'Satoru Gojo (Red)' },
	{ image_url: 'assets/views/main/images/IMG_8720.jpeg', categories: ['anime'], tags: ['jujutsu'], title: 'Jujutsu Kaisen', character: 'Satoru Gojo & Suguru Geto Betta Fish' },
	{ image_url: 'assets/views/main/images/IMG_8741.jpeg', categories: ['custom-text'], title: 'Special Occasions', character: 'Wedding: Emerald Mr.' },
	{ image_url: 'assets/views/main/images/IMG_8740.jpeg', categories: ['custom-text'], title: 'Special Occasions', character: 'Wedding: Pearl Mrs.' },
	{ image_url: 'assets/views/main/images/IMG_8739.jpg', categories: ['custom-text'], title: 'Special Occasions', character: 'Custom Message\n"4lifers"' },
	//        { image_url: 'assets/views/main/images/IMG_6203.JPG', category: 'custom-text' },
	...
	{ image_url: 'assets/views/main/images/IMG_5953_Original.JPEG', categories: ['baby-shoes'], character: 'Canticos: 1st Birthday' },
